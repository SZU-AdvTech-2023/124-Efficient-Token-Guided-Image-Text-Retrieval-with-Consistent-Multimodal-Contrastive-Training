...
from utils import cosine_sim, dot_sim
...
def main():
    ...
    parser.add_argument('--num_epochs', default=60, type=int, #60
    ...
    best_rsum = 0
    best_ndcg_sum = 0
    alignment_mode = config['training']['alignment-mode'] if 'alignment' in config['training']['loss-type'] else None
